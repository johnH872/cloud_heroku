		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${product.pro_id !=null && product.proper_id != null}">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/cac-san-pham/update" modelAttribute="product" >
						...
						<a href="/quan-tri/san-pham/cac-san-pham/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${Product._id == null && product.proper_id == null}">
					<h6 class="mb-4">Add new Product</h6>
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/cac-san-pham/create" modelAttribute="product" >
						<label class="form-label">Property ID</label> 
						<div class="form-floating mb-3">
							<form:select path="proper_id" class="form-select" id="floatingSelect"
								aria-label="Floating label select example"
