		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${property.proper_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/thuoc-tinh/update" modelAttribute="property" >
						<div class="mb-3">
						...
						<a href="/quan-tri/san-pham/thuoc-tinh/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${property.proper_id == null }">
					<h6 class="mb-4">Add new property</h6>
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/thuoc-tinh/create" modelAttribute="property" >
						<label class="form-label">Pet weight</label>
						<div class="form-floating mb-3">
							<form:select path="petwei_id" class="form-select" id="floatingSelect"
								aria-label="Floating label select example"
