		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${supplier.sup_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/nha-phan-phoi/update" modelAttribute="supplier" >
						...
						<a href="/quan-tri/san-pham/nha-phan-phoi/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${supplier.sup_id == null }">
					<h6 class="mb-4">Add new Supplier</h6>
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/san-pham/nha-phan-phoi/create" modelAttribute="supplier" >
						<div class="mb-3">
							<label for="InputSupName" class="form-label">Name</label>
							<form:input path="name" type="text" class="form-control" id="InputSupName" required="required"/>
						</div>
