		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${deliCompany.deli_com_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/cong-ty-van-chuyen/update" modelAttribute="deliCompany" >
						...
						<a href="/quan-tri/don-hang/cong-ty-van-chuyen/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${deliCompany.deli_com_id == null }">
					<h6 class="mb-4">Add new delivery company</h6>
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/cong-ty-van-chuyen/create" modelAttribute="deliCompany" >
						<div class="mb-3">
							<label for="InputDeliCompanyName" class="form-label">Name</label>
							<form:input path="name" type="text" class="form-control" id="InputDeliCompanyName" required="required"/>
						</div>
