		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${orderDetail.order_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/chi-tiet-don-hang/update" modelAttribute="orderDetail" >
						...
						<a href="/quan-tri/don-hang/chi-tiet-don-hang/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${orderDetail.order_id ==null}">
					<h6 class="mb-4">Add new order detail</h6>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/chi-tiet-don-hang/create" modelAttribute="orderDetail" >
						<label class="form-label">Product ID</label> 
						<div class="form-floating mb-3">
							<form:select path="pro_id" class="form-select" id="floatingSelect"
								aria-label="Floating label select example"
