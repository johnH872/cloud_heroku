		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${order.order_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/cac-don-hang/update" modelAttribute="order" >
						...
						<a href="/quan-tri/don-hang/cac-don-hang/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${order.order_id == null }">
					...
					<i>${error}</i>
					<label class="form-label">Account</label> 
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/cac-don-hang/create" modelAttribute="order" >
						<div class="form-floating mb-3">
							<form:select path="acc_id" class="form-select" id="floatingSelect"
								aria-label="Floating label select example"
								style="padding-top: 0px !important; padding-bottom: 0px !important;">
