		...
		<div class="col-sm-12 col-xl-6">
			<div class="bg-light rounded h-100 p-4">
				<c:if test="${deliService.deli_ser_id !=null }">
					...
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/dich-vu-van-chuyen/update" modelAttribute="deliService" >
						...
						<a href="/quan-tri/don-hang/dich-vu-van-chuyen/list"><button style="margin-left: 100px !important" type="button" class="btn btn-danger m-2">Quay lại</button></a>
					</form:form>
				</c:if>
				<c:if test="${deliService.deli_ser_id == null }">
					<h6 class="mb-4">Add new delivery service</h6>
					<i>${error}</i>
					<form:form id="myForm" method="POST" action="/quan-tri/don-hang/dich-vu-van-chuyen/create" modelAttribute="deliService" >
						<div class="form-floating mb-3">
							<form:select path="deli_com_id" class="form-select" id="floatingSelect"
								aria-label="Floating label select example"
								style="padding-top: 0px !important; padding-bottom: 0px !important;">
